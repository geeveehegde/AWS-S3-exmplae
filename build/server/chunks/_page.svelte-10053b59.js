import { c as create_ssr_component, v as validate_component, d as each, e as escape, f as compute_rest_props, g as getContext, h as spread, i as escape_attribute_value, j as escape_object, k as is_void, l as add_attribute, s as setContext, n as noop, o as compute_slots } from './index-ca5eb12c.js';
...
function requireClassnames () {
	if (hasRequiredClassnames) return classnamesExports$1;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${``}
${``}
<div class="flex justify-center">${validate_component(Card, "Card").$$render($$result, {}, {}, {
      default: () => {
        return `<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Create, Read, Update, Delete on Files using AWS S3</h5>
		<div class="space-x-4 space-y-4"><div class="flex items-center space-x-4"><form class="flex space-x-2" action="/">${validate_component(Label, "Label").$$render($$result, { class: "space-y-2" }, {}, {
          default: () => {
            return `<span>Upload file</span>
						<div class="flex items-center space-x-2">${validate_component(Fileupload, "Fileupload").$$render($$result, { id: "with_helper", class: "mb-2" }, {}, {})}
          ...
          {},
          {
            default: () => {
              return `${each(items, (item) => {
                return `${validate_component(Li, "Li").$$render($$result, { class: "pb-3 sm:pb-4", icon: true }, {}, {
                  default: () => {
                    return `<div class="flex items-center space-x-4"><div class="flex-1 min-w-0"><p class="text-sm font-medium text-gray-900 truncate dark:text-white my-2">${escape(item.Key)}</p></div>
...
//# sourceMappingURL=_page.svelte-10053b59.js.map
